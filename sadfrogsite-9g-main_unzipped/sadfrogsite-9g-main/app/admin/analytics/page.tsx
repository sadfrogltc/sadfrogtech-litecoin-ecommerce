    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Store performance insights and metrics</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Detailed analytics and reporting features will be available here</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-center py-12">
            <BarChart3 className="mx-auto h-12 w-12 text-muted-foreground" />
            <h3 className="mt-4 text-lg font-semibold">Analytics Coming Soon</h3>
            <p className="text-muted-foreground mt-2">Advanced analytics and reporting features are in development</p>
          </div>
        </CardContent>
      </Card>
    </div>
